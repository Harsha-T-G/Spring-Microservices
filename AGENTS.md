...
two independent services, RestClient and separate PostgreSQL databases. Current user
...
- Use separate PostgreSQL databases with Flyway migrations. Keep JDBC storage local
  to each service; do not add JPA, authentication, Security/CSRF configuration,
