...
built JARs using [README commands](../README.md). Use a fresh Inventory database
...
| 7:00–8:00 | Restart Inventory; retry a failed key after the five-second open wait | HALF_OPEN trial restores service; show stock/history persist across restart |
...
exercise recovery, and Order; final assertions verify persisted stock, orders and replay.
